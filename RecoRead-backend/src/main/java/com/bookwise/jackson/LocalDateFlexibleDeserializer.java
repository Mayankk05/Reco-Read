...
/**
 * Allows "yyyy", "yyyy-MM", or "yyyy-MM-dd" for LocalDate fields.
 * Missing month/day default to the 1st of the month or year.
 * Only applied to AddBookRequest.publishedDate (field-level annotation),
 * so it won't affect other endpoints.
 */
